...
#' \describe{
#'  \item{\code{model}}{Character string with the name of the model (\code{"bart_exp"}).}
...
#' output <- bart_exp(data = "example", niter = 2000, nwarmup = 1000, nchain = 3, ncore = 3)
#'
